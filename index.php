...
if ($_SESSION['loginid'] != ""){
	...
	LeagueAddPlayer($_SESSION['loginid'],0,1,0,0,0,0,0);
...
$magic_categories['magic_all_articles']		= "1:2";
...
echo "	<a href=\"".$eden_cfg['url']."index.php?action=market\" target=\"_self\" title=\"Tržnice\"><img src=\"".$eden_cfg['url_skins'].$eden_project_skin."/images/sys_menu_tabmenu_left.gif\" width=\"12\" height=\"27\" alt=\"Tržnice\" title=\"Tržnice\" align=\"middle\">&nbsp;Tržnice&nbsp;<img src=\"".$eden_cfg['url_skins'].$eden_project_skin."/images/sys_menu_tabmenu_right.gif\" width=\"12\" height=\"27\" align=\"middle\" alt=\".\"></a>\n";
...
echo "		<a href=\"".$eden_cfg['url']."index.php?action=fun_cards_comp\" target=\"_self\" title=\"Soutěže\">Soutěže</a>&nbsp;&nbsp;|&nbsp;&nbsp;\n";
echo "		<a href=\"".$eden_cfg['url']."index.php?action=fun_cards\" target=\"_self\" title=\"Karty\">Karty</a>&nbsp;&nbsp;|&nbsp;&nbsp;\n";
echo "		<a href=\"".$eden_cfg['url']."index.php?action=fun_cards_instr\" target=\"_self\" title=\"Návod\">Návod</a>\n";
echo "	</div>\n";
...
if ($_GET['action'] != "forum"){
	...
	echo "			</tr>\n";
	echo "			<tr>\n";
	echo "				<td><input type=\"submit\" value=\""._DICT_SHOW_WORD."\" class=\"eden_button\"><br>\n";
	echo "				<a href=\"index.php?action=mtg_card_list\" target=\"_self\">Seznam karet</a></td>	\n";
	echo "			</tr>\n";
	echo "		</table></form>\n";
	echo "	</div>\n";
	echo "</div>\n";
	...
	echo "			</tr>\n";
	echo "			<tr>\n";
	echo "				<td><input type=\"submit\" value=\""._DICT_SHOW_WORD."\" class=\"eden_button\">"; if ($_SESSION['loginid'] != ""){ echo " &nbsp; <a href=\"index.php?action=dict&amp;lang=".$_GET['lang']."&amp;mode=dict_add_word\">"._DICT_ADD_WORD."</a>"; } echo "<br>\n";
	echo "				<a href=\"index.php?action=dict\" target=\"_self\">Slovník</a></td>	\n";
	echo "			</tr>\n";
	echo "		</table></form>\n";
	echo "	</div>\n";
	echo "</div>\n";
...
if ($_GET['action'] == "article" || $_GET['action'] == "msg"){
	...
	$_GET['action'] == "rules" || 
	$_GET['action'] == "market" || 
	$_GET['action'] == "fun_cards" || 
	$_GET['action'] == "fun_cards_comp" || 
	...
	$_GET['action'] == "eshops"){
		...
		switch ($_GET['action']){
			...
			case "decklist_show":
				...
				echo $decklist->showDecklist($_GET['did']);
			break;
			case "decklists":
				$decklist = new MtGDecklists($eden_cfg);
			...
			echo "	<div class=\"content_template_col_text\">\n";
				...
				*******************************************************/
				if ($_GET['action'] == "mtg_card_list"){
					...
					echo $mtg_list->showCardList($_GET);
				}
				/*******************************************************
				*
				*	SHOW MtG CARD
				...
				*******************************************************/
				if ($_GET['action'] == "user_details"){
					if ($_SESSION['u_status'] == "user" || $_SESSION['u_status'] == "admin"){
						UserDetails($_GET['user_id']);
						GuestBookAdmin($_GET['user_id'],610,"center");
					} else {
