	...
	<tr>
		<td class="eden_mtg_left_col">
			<div style="width:199px; height: 285px; border:10px solid #000000;border-radius:10px;-moz-border-radius:10px;">
				<img src="<?php echo _URL_MTG_CARDS.$ar_mtg_card['mtg_card_set_code']."/".toAscii($ar_mtg_card['mtg_card_name']).$ar_mtg_card['mtg_card_variation'];?>.full.jpg" width="199" height="285" border="0" alt="<?php echo $ar_mtg_card['mtg_card_name'];?>">
			</div>
		</td>
